...
build_uboot()
{
	...
	cp ${UBOOT_ROOT}/u-boot.bin ${OUT_ROOT}/u-boot.bin
}
...
build_linux()
{
	...
	./scripts/dtc/dtc -I dts -O dtb -o arch/arm/boot/dts/sun4i-a10-cubieboard.dtb arch/arm/boot/dts/sun4i-a10-cubieboard.dts
